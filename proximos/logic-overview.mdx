...
2. Proximos will refresh its settings and automatically heal within 10 minutes of a corrected plist being deployed.
3. Or, restart the Proximos application to force Proximos to re-read the corrected file immediately.
