...
1. Download the latest [Proximos DMG](https://files.enlazosystems.com/Proximos/Proximos.dmg) — this link always points to the newest version — or use the link provided in your purchase confirmation email.
