...
<CardGroup cols={2}>
  <Card title="Terms of Service / No License" icon="hand-wave">
  ...
  <Card title="Checking for Updates" icon="arrow-clockwise">
  ...
  <Card title="Update Available" icon="triangle-exclamation">
  ...
  <Card title="Version Skip Active" icon="forward-step">
  ...
  <Card title="Software Update Error" icon="triangle-exclamation">
  ...
  <Card title="Configuration Error" icon="triangle-exclamation">
...
<Note>
  The spinning **arrow.clockwise** icon is used during active checks and is compatible with macOS 13 and later. It is rotated in code rather than relying on SF Symbols 5 animation APIs, which require macOS 15 or later.
</Note>