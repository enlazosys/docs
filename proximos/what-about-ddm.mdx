...
- **Still requires the user to enter their password to update.** If the user avoids entering it, the update will likely never install — DDM does not bypass the human cooperation requirement described in [Why Does Proximos Exist?](/proximos/why-does-proximos-exist).
