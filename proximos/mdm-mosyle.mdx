...
5. Click the blue Upload button, then Click Choose a file and select the [Proximos PKG file](https://files.enlazosystems.com/Proximos/Proximos.pkg) (download it first if you haven't already — this link always hosts the latest version)
