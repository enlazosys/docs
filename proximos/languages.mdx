---
title: "Languages"
description: "How Proximos localization works, the ten supported languages, and how to set the display language per user."
icon: "languages"
---
...
## Implementing Languages for Custom Features Caution

It is unknown what other non-latin languages and special characters or accents may cause with behavior in Proximos' custom notifications and Nudge configurations features. Nudge and Daily Notifications messages are passed through POSIX Unix underpinnings which may cause some some characters to appear as blank text, which can cause operational issues with daily notifications not appearing or functioning properly.

For this reason, Enlazo can only formally support Proximos operation with Custom Notifications and Nudge text workflows in English.
