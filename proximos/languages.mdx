...
For this reason, Enlazo can only formally support Proximos operation with Custom Notifications and Nudge text workflows in English. If you notice missing characters or notifications are not displaying, please try troubleshooting your custom text in English.
