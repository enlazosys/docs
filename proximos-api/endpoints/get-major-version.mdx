...
[
  {
    "major_version": 8.5,
    "board_id_major_version": "M5521:8.5",
...
<ResponseField name="resolved_board_id" type="string">
  ...
  - **Mac OS X PowerPC (10.0–10.5):** Apple model number (e.g. `M5183` for Power Mac G3 B&W \+ G4 PCI–DA)
  - **Mac OS X Intel (10.6–10.15):** Intel board ID (e.g. `Mac-F4208EAA`)
